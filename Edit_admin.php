<?php
    ...
    session_start();
    $edit_id = $_GET["id"];
    $edit_query = "select * from admin_info where id='$edit_id'";
   ...
   <div class="content-main">
      ...
      <!--banner-->	
        <div class="banner">
            ...
            <h2>
            <a href="Manage_admin.php">Profile</a>
		...
		<div class="main-agileits col-md-8 col-md-offset-2" style="margin-top:-105px;">
				<div class="form-w3agile form1">
					<h3 style="font-size:30px; padding-top:10px;">Edit Admin Profile!</h3>
					<form action="#" method="post" enctype="multipart/form-data">
						<div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>
							<input  type="text"  value="<?php echo $row[1]  ?>" name="admin_name"required="" >
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-envelope" aria-hidden="true"></i>
							<input  type="text"  value="<?php echo $row[2]  ?>" name="admin_email" required="">
							<div class="clearfix"></div>
						</div>
						
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>
							<input  type="password"  value="<?php echo $row[3]  ?>" name="pass" required="">
							<div class="clearfix"></div>
						</div>
				
						<div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>
							<input  type="text"  value="<?php echo $row[4]  ?>" name="position" required="">
							<div class="clearfix"></div>
						</div>

                        <div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>
							<input style="margin-top:10px;" value="<?php echo $row[5]  ?>" type="file" name="txtfile" required="">
							<div class="clearfix"></div>
						</div>

						<input type="submit" name="btnsave" value="Save Changes" required="">
                   ...
                   if(isset($_POST['btnsave']))
                    {
                      ...
                      move_uploaded_file($oldlocation,$newlocation);
                        ...
                        $update = "update admin_info set name='$Admin_name', email='$email_id' , password='$pas' , role='$role' , img='$filename'  
                         where id='$admin_id'";
                        $run_insert = mysqli_query($con,$update);
                         ...
                         if($run_insert>0)
                         {
                            ...
                            <b>Successfull!</b>Admin Detail has been Updated..
                            </div>
                             ";
                         }
                         else
