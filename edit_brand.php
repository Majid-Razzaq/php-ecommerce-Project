...
<div id="wrapper" >
   ...
   <div class="content-main">
     ...
     <h3 id="forms-example" class="">Add New brand</h3>
     <hr>
     <form method="post">
<div class="form-group">
 <h4 style="padding-left:20px;">Edit Brand Name</h4>
<input  type="text" value="<?php echo $row[1]  ?>" name="brand" class="form-control cat"placeholder="Type brand here...">
...
if(isset($_POST['btnsave']))
      {
        ...
        $update = "update brand set b_name ='$name' where brand_id = '$b_id'";
        ...
        if($run_insert>0)
        {
            ...
            <b>Successfull!</b> $name Brand has been Updated..
          </div>
            ";
        }
        else
