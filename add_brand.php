...
<body>
       ...
       <div class="content-main">
 		...
 		<h3 id="forms-example" class="">Add New Brands</h3>
         <hr>
 		<form method="post">
  <div class="form-group">
     <h4 style="padding-left:20px;">Brand Name</h4>
    <input  type="text" name="brand" class="form-control cat" required="">
  ...
  if(isset($_POST['btn']))
		  {
			  ...
			  $query = mysqli_query($con,"insert into brand(b_name)
			  values ('$brand_name')");
              ...
              if($query > 0)
			  {
                ...
                <b>Successfull!</b> $brand_name Brand has been inserted..
              </div>
                ";
			  }
			  else
