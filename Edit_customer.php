       ...
       <div class="content-main">
		...
		<div class="main-agileits col-md-8 col-md-offset-2" style="margin-top:-105px;">
				<div class="form-w3agile form1">
					<h3 style="font-size:30px; padding-top:10px;">Edit Customers Details!</h3>
					<form action="#" method="post" enctype="multipart/form-data">
						...
						<div class="key">
							...
							<input  type="password"  value="<?php echo $row[3]  ?>" name="password" >
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-phone" aria-hidden="true"></i>
							<input  type="text"  value="<?php echo $row[4]  ?>" name="num" >
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-address-card" aria-hidden="true"></i>
							<input  type="text"  value="<?php echo $row[5]  ?>" name="add">
							<div class="clearfix"></div>
						</div>
                   ...
                   if(isset($_POST['btnsave']))
                    {
                      ...
                      $location  = $_POST["add"];
                        ...
                        $update = "update user_info set username='$name', email='$email_id' , password='$pas' , contact='$cont' , address='$location'  
                         where id='$user_id'";
                        $run_insert = mysqli_query($con,$update);
                         ...
                         if($run_insert>0)
                         {
                            ...
                            <b>Successfull!</b>Customer Detail has been Updated..
                            </div>
                             ";
                         }
                         else
